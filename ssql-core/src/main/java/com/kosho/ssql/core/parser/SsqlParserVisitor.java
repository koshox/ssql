...
public interface SsqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SsqlParser#selectStatment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelectStatment(SsqlParser.SelectStatmentContext ctx);
	/**
	 * Visit a parse tree produced by {@link SsqlParser#bracketedSelectStatment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitBracketedSelectStatment(SsqlParser.BracketedSelectStatmentContext ctx);
	/**
	 * Visit a parse tree produced by {@link SsqlParser#simpleSelectStatment}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSimpleSelectStatment(SsqlParser.SimpleSelectStatmentContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code selectSepcialColumns}
	 * labeled alternative in {@link SsqlParser#selectColumns}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelectSepcialColumns(SsqlParser.SelectSepcialColumnsContext ctx);
	/**
